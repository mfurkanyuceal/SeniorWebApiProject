    ...
    public class LocationController : Controller
    {
        ...
        public async Task<IActionResult> CreateNeighborhood([FromBody] CreateNeighborhoodRequest neighborhoodRequest)
        {
            ...
            var locationUrl = baseUrl + "/" +
                              ApiRoutes.Addresses.Get.Replace("{neighborhoodId}", neighborhood.Id.ToString());
        ...
        public async Task<IActionResult> UpdateAddress([FromRoute] int addressId,
        ...
        public async Task<IActionResult> UpdateDistrict([FromRoute] int districtId,
        ...
        public async Task<IActionResult> UpdateNeighborhood([FromRoute] int neighborhoodId,
