    ...
    public partial class InitialCrete : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FieldOfInterests", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderUserId = table.Column<string>(nullable: true),
                    RecieverUserId = table.Column<string>(nullable: true),
                    SwapDate = table.Column<string>(nullable: true),
                    SendedDate = table.Column<string>(nullable: true),
                    AcceptedDate = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Swaps_AspNetUsers_RecieverUserId",
                        column: x => x.RecieverUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Swaps_AspNetUsers_SenderUserId",
                        column: x => x.SenderUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Swaps_AddressId",
                table: "Swaps",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_Swaps_RecieverUserId",
                table: "Swaps",
                column: "RecieverUserId");
